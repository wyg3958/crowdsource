...
public class ProjectController {
    ...
    public void saveProject(@RequestBody @Valid ProjectStorage projectStorage, Principal principal) {
        ...
        projectEntity.setDescription(projectStorage.getDescription());
        projectEntity.setShortDescription(projectStorage.getShortDescription());
        projectEntity.setTitle(projectStorage.getTitle());
